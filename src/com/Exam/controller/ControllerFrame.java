...
public class ControllerFrame extends javax.swing.JFrame {// 主控制窗体
	...
	private void initComponents() {// 初始化方法
		...
		addreadItem = new javax.swing.JMenuItem();/*yezi 2013-5-15*/
		...
		/*yezi 2013-5-15 begin*/
		addreadItem.setText("增加阅读题");
		addMenu.add(addreadItem);
		addreadItem.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				addreadItemActionPerformed(evt);
			}
		});
		/*yezi 2013-5-15 end */
	...
	/*yezi 2013-5-15 begin*/
	private void addreadItemActionPerformed(java.awt.event.ActionEvent evt) {
		dispose();
		AddReadFrame addReadFrame = new AddReadFrame();
		addReadFrame.setVisible(true);
		addReadFrame.setBounds(200, 100, 400, 500);
	}
	/*yezi 2013-5-15 end*/
	...
	private javax.swing.JMenuItem addreadItem;
