...
public class UpdateExamParameter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        /*yezi 2013-5-19 begin*/
        readBL = new javax.swing.JLabel();
        readjComboBox = new javax.swing.JComboBox();
        readJLabel = new javax.swing.JLabel();
        readMarkjLabel = new javax.swing.JLabel();
        readMarkjComboBox = new javax.swing.JComboBox();
        /*yezi 2013-5-19*/
        ...
        /*yezi 2013-5-19*/
        readBL.setText("阅读题比例：");
        readjComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "80", "70", "60", "50","40","30","20","10" }));
        readjComboBox.setSelectedItem(""+stat.getRead_BL());
        readJLabel.setText("%");
        /*yezi 2013-5-19*/
        ...
        /*yezi 2013-5-19*/
        readMarkjLabel.setText("阅读题分值：");
        readMarkjComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "5", "8", "10"}));
        readMarkjComboBox.setSelectedItem(""+stat.getRead_FS());
        /*yezi 2013-5-19*/
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                                        ...
                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                .addComponent(readBL)/*yezi 2013-5-4*/
                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                .addComponent(readjComboBox , 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))/*yezi 2013-5-4*/
                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                        ...
                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                                                                ...
                                                                                                .addComponent(readJLabel , javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))/*yezi 2013-5-4*/
                                                                                ...
                                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                        ...
                                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                                .addComponent(readMarkjLabel )
                                                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                .addComponent(readMarkjComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(readBL )
                                        .addComponent(readjComboBox , javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(readJLabel )
                                        .addComponent(readMarkjLabel )
                                        .addComponent(readMarkjComboBox , javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(15, 15, 15)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void okjButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String readBox = readjComboBox.getSelectedItem().toString();/*yezi 2013-5-19*/
        if((Integer.parseInt(radioBox)+Integer.parseInt(moreBox)+Integer.parseInt(judgeBox)+Integer.parseInt(readBox))!=100){
        ...
        stat.setRead_BL(Integer.parseInt(readBox));/*yezi 2013-5-19*/
        stat.setRead_FS(Integer.parseInt(readMarkjComboBox.getSelectedItem().toString()));/*yezi 2013-5-19*/
    ...
    /*yezi 2013-5-19*/
    private javax.swing.JLabel readBL;
    private javax.swing.JComboBox readjComboBox;
    private javax.swing.JLabel  readJLabel;
    private javax.swing.JLabel readMarkjLabel;
    private javax.swing.JComboBox readMarkjComboBox;
